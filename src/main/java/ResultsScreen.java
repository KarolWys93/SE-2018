...
public class ResultsScreen {
    ...
    public ResultsScreen(List<MicroControllerEntity> ucList) {
        ...
        selectedUcList.setModel(new UCListModel(ucList.subList(0, ucList.size() < 50 ? ucList.size() : 50)));
...
//            detailsScrollPanel.getHorizontalScrollBar().setValue(detailsScrollPanel.getHorizontalScrollBar().getMinimum());
//            detailsScrollPanel.getVerticalScrollBar().setValue(detailsScrollPanel.getHorizontalScrollBar().getMinimum());
        });
